...
'use strict';
{
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            const title_available = quickElement('h2', selector_available, interpolate(gettext('Available %static') + ' ', [field_name]));
            quickElement(
                'span', title_available, '',
                'class', 'help help-tooltip help-icon',
                'title', interpolate(
                    gettext(
                        'This is the list of available %static. You may choose some by ' +
            ...
            quickElement(
                ...
                'title', interpolate(gettext("Type into this box to filter down the list of available %static."), [field_name])
            );
            ...
            const choose_all = quickElement('a', selector_available, gettext('Choose all'), 'title', interpolate(gettext('Click to choose all %static at once.'), [field_name]), 'href', '#', 'id', field_id + '_add_all_link');
            ...
            const title_chosen = quickElement('h2', selector_chosen, interpolate(gettext('Chosen %static') + ' ', [field_name]));
            quickElement(
                'span', title_chosen, '',
                'class', 'help help-tooltip help-icon',
                'title', interpolate(
                    gettext(
                        'This is the list of chosen %static. You may remove some by ' +
                        'selecting them in the box below and then clicking the ' +
            ...
            const clear_all = quickElement('a', selector_chosen, gettext('Remove all'), 'title', interpolate(gettext('Click to remove all chosen %static at once.'), [field_name]), 'href', '#', 'id', field_id + '_remove_all_link');
