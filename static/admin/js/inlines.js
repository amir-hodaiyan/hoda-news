 ...
 * All rights reserved.
 *
 * Spiced up with Code from Zain Memon'static GSoC project 2009
...
'use strict';
{
    ...
    $.fn.formset = function(opts) {
        ...
        const addInlineClickHandler = function(e) {
            ...
            nextIndex += 1;
            // Hide the add button if there'static a limit and it'static been reached.
        ...
        const addInlineDeleteButton = function(row) {
            if (row.is("tr")) {
                ...
                // last child element of the form'static container:
