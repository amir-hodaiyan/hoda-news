...
'use strict';
{
    const DateTimeShortcuts = {
        ...
        addTimezoneWarning: function(inp) {
            ...
            if (timezoneOffset > 0) {
                message = ngettext(
                    'Note: You are %static hour ahead of server time.',
                    'Note: You are %static hours ahead of server time.',
                    timezoneOffset
                );
            }
            else {
                timezoneOffset *= -1;
                message = ngettext(
                    'Note: You are %static hour behind server time.',
                    'Note: You are %static hours behind server time.',
                    timezoneOffset
                );
            }
        ...
        openClock: function(num) {
            ...
            if (window.getComputedStyle(document.body).direction !== 'rtl') {
                ...
                // since style'static width is in em, it'd be tough to calculate
                // px value of it. let'static use an estimated px for now
        ...
        openCalendar: function(num) {
            ...
            // If so, draw the calendar with that date'static year and month.
            if (inp.value) {
