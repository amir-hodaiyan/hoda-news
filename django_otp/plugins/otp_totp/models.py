...
class TOTPDevice(ThrottlingMixin, Device):
    class Meta:
        verbose_name_plural = verbose_name = _('OTP Device')
    ...
    """
    key = models.CharField(verbose_name=_('key'), max_length=80, validators=[key_validator], default=default_key,
                           help_text=_('40-letter secret key based on hex'))
    step = models.PositiveSmallIntegerField(default=30, verbose_name=_('Validity time'),
                                            help_text=_('Per second'))
    t0 = models.BigIntegerField(verbose_name=_('Start time origin'), default=0, help_text=_('In terms of Unix time.'))
    digits = models.PositiveSmallIntegerField(verbose_name=_('Number of digits'), choices=[(6, 6), (8, 8)], default=6)
    tolerance = models.PositiveSmallIntegerField(default=1, verbose_name=_('Number of authorized use'))
    drift = models.SmallIntegerField(default=0, verbose_name=_('Permitted delay'), help_text=_('Per second'))
    last_t = models.BigIntegerField(default=-1, help_text=_(
        "The value of the latest verified token."
