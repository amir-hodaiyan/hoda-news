...
class OTPAuthenticationFormMixin:
    ...
    otp_error_messages = {
        ...
        'not_interactive': _('The selected encryption device is not interactive'),
        'challenge_message': _('OTP Challenge: {0}'),
        'invalid_token': _('The token entered is invalid.'),
        'n_failed_attempts': ngettext_lazy(
            "Attempting to enter one-time code is excessive %(failure_count)% ",
            "Attempting to enter one-time code is excessive %(failure_count)% ", "failure_count"),
